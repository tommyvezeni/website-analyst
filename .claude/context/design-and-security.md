...
Limiti di risorse: `max_pages` vincolato 1..300, un job di crawl alla volta (o piccola coda) perche' ogni run apre un Chromium reale: troppi crawl paralleli su 6 vCPU degradano la VM.
